...
switch ($_GET['action']) {
    ...
    case 'delete':
        ...
        $query = mysqli_query($koneksi, "UPDATE `potempahan` SET  Tipe = 'Z' WHERE  Kode='$Kode'");
        $query12 = mysqli_query($koneksi, "UPDATE `ststempahan` SET  Tipe = 'Z' WHERE  Kodetempahan='$Kode'");
        break;
}
