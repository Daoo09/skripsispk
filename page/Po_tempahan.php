        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Purchase Order Tempahan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Purchase Order Tempahan</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#contentData").on("submit", "#formAdd", function(e) {
                ...
                $.ajax({
                    url: 'service_potempahan.php?action=save',
                    type: 'post',
            ...
            $("#contentData").on("submit", "#formEdit", function(e) {
                ...
                var data = new FormData(form);
                $.ajax({
                    url: 'service_potempahan.php?action=edit',
                    // type: 'post',
                    // data: $(this).serialize(),
                    type: 'post',
                    enctype: 'multipart/form-data',
            ...
            $("#contentData").on("click", "#DeleteButton", function() {
                if (confirm('Apakah anda yakin ingin menghapus data ini ?')) {
                    ...
                    $.ajax({
                        url: 'service_potempahan.php?action=delete',
                        type: 'post',
                        data: {
                            Kode: Kode
                        },
                        success: function(data) {
                            ...
                            Toast.fire({
                                ...
                                .then(function() {
                                    $('#contentData').load("table-potempahan.php");
                                });
                        }
                    });
                } else {
