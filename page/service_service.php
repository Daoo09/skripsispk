...
switch ($_GET['action']) {
    case 'save':
        ...
        if ($gambar_file != "") {
            ...
            if (in_array($ekstensi, $ekstensi_diperbolehkan) == true) {
                ...
                $cekkode    = mysqli_num_rows(mysqli_query($koneksi, "SELECT `Kode` FROM `poservice` WHERE Kode='$_POST[Kode]' AND Tipe!='Z' "));
                if ($cekkode > 0) {
                    echo 2;   # ini untuk pemberitahuan bahwa kode tidak boleh sama
                } else {
                    # ini untuk insertnya
                    $query = mysqli_query($koneksi, "INSERT INTO `poservice`(`id`, `Kode`, `KodePelanggan`, `NamaSales`, `TanggalTerima`, `TanggalEstimasiPenyelesaian`, `KodeProduk`, `JenisProduksi`, `JenisPelanggan`, `Bahan`, `KadarLokal`, `Kuantitas`, `Ukuran`, `EstimasiBerat`, `RangeBeratEstimasi`, `Susut`, `DatangBerlian`, `BeratDatangBerlian`, `UpahPasangBerlian`, `NamaBatuPermata`, `BeratBatuPermata`, `TipeIkatan`, `Metode`, `TipePelanggan`, `Keterangan`, `Foto`, `KrumWarna`, `KeteranganKrum`, `HargaKrum`, `Upah`, `Budget`, `Panjar`, `Tipe`, `Tanggal`, `User`, `Status`) VALUES ('','$Kode','$KodePelanggan','$NamaSales','$TanggalTerima','$TanggalEstimasiPenyelesaian','$KodeProduk','$JenisProduksi','$JenisPelanggan','$Bahan','$KadarLokal','$Kuantitas','$Ukuran','$EstimasiBerat','$RangeBeratEstimasi','$Susut', '$DatangBerlian','$BeratDatangBerlian','$UpahPasangBerlian','$NamaBatuPermata','$BeratBatuPermata','$TipeIkatan','$Metode','$TipePelanggan','$Keterangan','$nama_baru','$KrumWarna','$KeteranganKrum','$HargaKrum','$Upah','$Budget','$Panjar', '', '$Tanggal', '$User', '1')");

                     /* ini untuk insert otomatis Status Pemesanan */
                     $status = mysqli_query($koneksi, "INSERT INTO `stsservice` (`id`, `Kodeservice`, `Sk`, `Selesai`, `Pb`, `Tipe`) VALUES ('', '$Kode', '', '', '', '')");
                     /** Selelsai */
                }
            } else {
            ...
            if ($cekkode > 0) {
                ...
                # ini untuk insertnya
                $query = mysqli_query($koneksi, "INSERT INTO `poservice`(`id`, `Kode`, `KodePelanggan`, `NamaSales`, `TanggalTerima`, `TanggalEstimasiPenyelesaian`, `KodeProduk`, `JenisProduksi`, `JenisPelanggan`, `Bahan`, `KadarLokal`, `Kuantitas`, `Ukuran`, `EstimasiBerat`, `RangeBeratEstimasi`, `Susut`, `DatangBerlian`, `BeratDatangBerlian`, `UpahPasangBerlian`, `NamaBatuPermata`, `BeratBatuPermata`, `TipeIkatan`, `Metode`, `TipePelanggan`, `Keterangan`, `Foto`, `KrumWarna`, `KeteranganKrum`, `HargaKrum`, `Upah`, `Budget`, `Panjar`, `Tipe`, `Tanggal`,`User`, `Status`) VALUES ('','$Kode','$KodePelanggan','$NamaSales','$TanggalTerima','$TanggalEstimasiPenyelesaian','$KodeProduk','$JenisProduksi','$JenisPelanggan','$Bahan','$KadarLokal','$Kuantitas','$Ukuran','$EstimasiBerat','$RangeBeratEstimasi','$Susut', '$DatangBerlian','$BeratDatangBerlian','$UpahPasangBerlian','$NamaBatuPermata','$BeratBatuPermata','$TipeIkatan','$Metode','$TipePelanggan','$Keterangan','','$KrumWarna','$KeteranganKrum','$HargaKrum','$Upah','$Budget','$Panjar', '','$Tanggal','$User', '1')");
    ...
    case 'delete':
        ...
        $query = mysqli_query($koneksi, "UPDATE `poservice` SET  Tipe = 'Z' WHERE  Kode='$Kode'");
        $query12 = mysqli_query($koneksi, "UPDATE `stsservice` SET  Tipe = 'Z' WHERE  Kodeservice='$Kode'");
