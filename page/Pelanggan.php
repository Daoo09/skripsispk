    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#contentData").on("submit", "#formAdd", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'service_pelanggan.php?action=save',
                    type: 'post',
                    data: $(this).serialize(),
            ...
            $("#contentData").on("submit", "#formEdit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'service_pelanggan.php?action=edit',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        const Toast = Swal.mixin({
            ...
            $("#contentData").on("click", "#DeleteButton", function() {
                if (confirm('Apakah anda yakin ingin menghapus data ini ?')) {
                    ...
                    $.ajax({
                        url: 'service_pelanggan.php?action=delete',
                        type: 'post',
                        data: {
                            id: id
                        },
                        success: function(data) {
                            if (data == 'success') {
                                ...
                                Toast.fire({
                                    ...
                                    .then(function() {
                                        // location.reload();
                                        $('#contentData').load("table-pelanggan.php");
                                    });
                            }
                        }
                    });
