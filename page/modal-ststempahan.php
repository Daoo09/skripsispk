...
<div id="content">
    ...
    include '../koneksi.php';
    $id = $_GET['id'];
    $query = mysqli_query($koneksi, "SELECT * FROM `ststempahan` WHERE id='$id' AND Tipe!='Z' ") or die(mysqli_error($koneksi));
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Data Status Pesanan Tempahan</h5>
                    ...
                    <div class="form-group row" style="margin-bottom:8px">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="" name="" 
                                value="<?php 
                                        $aku = $result['Kodetempahan'];
                                        $a = mysqli_query($koneksi, "SELECT * FROM `potempahan` WHERE Tipe!='Z' AND Kode='$aku' ");
