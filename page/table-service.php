        ...
        <div class="card-body">
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    include '../koneksi.php';
                    $no = 1;
                    $f4hri = mysqli_query($koneksi, "SELECT * FROM poservice WHERE Tipe!='Z' ");
                        ...
                        <tr>
                            ...
                            <td style="padding-top:0; padding-bottom:0; vertical-align: middle">
                                <center><a href="javascript:void(0)" class='btn btn-primary btn-sm open_modal' id='<?php echo $a['id']; ?>'><i class="fas fa-pencil-alt"></i></a>
                                    <button type="submit" id="DeleteButton" class='btn btn-danger btn-sm' value="<?php echo $a['Kode']; ?>"><i class="fas fa-trash"></i></button>
                                </center>
                            </td>
                        </tr>
                    <?php } ?>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">PO Tempahan</h5>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                $query  = mysqli_query($koneksi, "SELECT max(Kode) as kodeTerbesar FROM poservice WHERE Tipe!='Z' AND Kode LIKE '{$char}%' ORDER BY Kode DESC LIMIT 5");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                $char = "PRDK";
                                                # Mengambil data dengan kode yang paling besar
                                                $query  = mysqli_query($koneksi, "SELECT max(KodeProduk) as kodeTerbesar1 FROM poservice WHERE Tipe!='Z' AND KodeProduk LIKE '{$char}%' ORDER BY KodeProduk DESC LIMIT 5");
                                                $tampil = mysqli_fetch_array($query);
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                ?>
                                                <input type="text" id="" class="form-control" value="<?php echo  "Rp " . number_format($cek['harga'], 2, ',', '.'); ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="margin-bottom:8px">
                                        ...
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" id="" name="UpahPasangBerlian" class="form-control" placeholder="Upah Pasang Berlian (Rp)">
                                            </div>
                                        </div>
                                        <div class="form-group row" style="margin-bottom:8px">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="HargaKrum" id="" class="form-control" placeholder="Rp">
                                            </div>
                                        </div>
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <input type="hidden" name="Budget" id="Budget" class="form-control" value="">
                                            <div class="col-sm-4">
                                                <input type="number" name="Panjar" id="Panjar" class="form-control" value="" placeholder="Panjar (Rp)">
                                                <input type="hidden" name="Tanggal" id="Tanggal" class="form-control" value="<?php echo date('Y-m-d') ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
