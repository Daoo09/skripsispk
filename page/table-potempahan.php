        ...
        <div class="card-body">
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    include '../koneksi.php';
                    $no = 1;
                    $f4hri = mysqli_query($koneksi, "SELECT * FROM potempahan WHERE Tipe!='Z' ");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                $query  = mysqli_query($koneksi, "SELECT max(Kode) as kodeTerbesar FROM potempahan WHERE Tipe!='Z' AND Kode LIKE '{$char}%' ORDER BY Kode DESC LIMIT 5");
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                $char = "KDP";
                                                # Mengambil data dengan kode yang paling besar
                                                $query  = mysqli_query($koneksi, "SELECT max(KodeProduk) as kodeTerbesar1 FROM potempahan WHERE Tipe!='Z' AND KodeProduk LIKE '{$char}%' ORDER BY KodeProduk DESC LIMIT 5");
                                                $tampil = mysqli_fetch_array($query);
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row" style="margin-bottom:8px">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                ?>
                                                <input type="text" id="" class="form-control" value="<?php echo $hasil_rupiah = "Rp " . number_format($cek['harga'], 2, ',', '.');  ?>" disabled>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".view").click(function(e) {
                var m = $(this).attr("id");
                $.ajax({
                    url: "modal-invoicepotempahan.php",
                    type: "GET",
                    data: {
                        id: m,
                    },
