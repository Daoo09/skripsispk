        ...
        <div class="card-body">
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    include '../koneksi.php';
                    $no = 1;
                    $f4hri = mysqli_query($koneksi, "SELECT * FROM `stsservice` WHERE Tipe!='Z' ");
                    while ($a = mysqli_fetch_array($f4hri)) {
                        $Kode = $a['Kodeservice'];
                        $ini = mysqli_query($koneksi, "SELECT * FROM `poservice` WHERE Tipe!='Z' AND Kode = '$Kode' ");
                            ...
                            ?>
                                <td style="padding-top:0; padding-bottom:0; vertical-align: middle">
                                    <center><a href="javascript:void(0)" class='btn btn-primary btn-sm open_modal' id='<?php echo $a['id']; ?>'><i class="fas fa-pencil-alt"></i></a>
                                        <button type="submit" id="DeleteButton" class='btn btn-danger btn-sm' value="<?php echo $a['Kodeservice']; ?>"><i class="fas fa-trash"></i></button>
                                    </center>
                                </td>
                            <?php } ?>
                        </tr>
